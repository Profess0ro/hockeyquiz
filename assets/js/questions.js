const QUESTIONS = [
    {
        ...
        answers: [
            {text: 'He needed to go to the bathroom', correct: false},
            {text: 'He threw up', correct: false},
            {text: 'He was blinded by the sun', correct: true},
            {text: 'He lost his skate', correct: false}
        ]
    },
    {
